//Decrypt Dexguard strings using substraction obfuscation/deobfuscation technique
//@author Fare9
//@category Dexguard
//@keybinding 5
//@menupath 
...
public class Dexguard_string_sub_deobf extends GhidraScript {
	...
	private String decrypt_sub(byte subKey, Address startAddress, Address endAddress)
	{
		...
		for(j = 0; j < size; j++)
		{
			...
			decrypted_byte = (byte) (read_byte - subKey);
			subKey = decrypted_byte;
